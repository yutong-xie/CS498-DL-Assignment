...
def discriminator_loss(logits_real, logits_fake):
    ...
    loss =  bce_loss(logits_real, labels_real, reduction = 'mean') + bce_loss(logits_fake, labels_fake, reduction = 'mean')
...
def generator_loss(logits_fake):
    ...
    loss = bce_loss(logits_fake, labels, reduction = 'mean')
...
def ls_discriminator_loss(scores_real, scores_fake):
    ...
    loss = 1/2 * mse_loss(scores_real, labels_real, reduction = 'mean') + 1/2 * mse_loss(scores_fake, labels_fake, reduction = 'mean')
    ##########       END      ##########
